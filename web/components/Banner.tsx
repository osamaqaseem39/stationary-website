  ...
  return (
    <div className="relative w-full h-64 md:h-80 lg:h-96 mb-12 overflow-hidden rounded-3xl animate-fadeInUp">
      ...
      <div className="absolute inset-0 bg-primary/10">
        ...
        <div className="absolute top-10 right-10 w-32 h-32 bg-secondary/20 rounded-full blur-2xl animate-blob"></div>
        <div className="absolute bottom-10 left-10 w-40 h-40 bg-primary/20 rounded-full blur-2xl animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="relative z-10 h-full flex items-center animate-fadeInLeft">
        <div className="ml-4 md:ml-8 lg:ml-16 bg-white/95 backdrop-blur-md rounded-3xl p-6 md:p-8 lg:p-10 max-w-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 border border-white/50 card-hover animate-scaleIn">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 animate-fadeInDown">
            {title}
          </h1>
          {description && (
          ...
          <div className="mt-6 w-20 h-1 bg-primary rounded-full animate-scaleIn animation-delay-400"></div>
        </div>
      </div>
      
      {/* Shine effect */}
      <div className="absolute inset-0 opacity-0 hover:opacity-100 transition-opacity duration-1000">
        <div className="absolute inset-0 bg-white/20 transform -skew-x-12 -translate-x-full hover:translate-x-full transition-transform duration-2000"></div>
      </div>
    </div>
  )
}
